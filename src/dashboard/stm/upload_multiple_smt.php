...
<div class="conatiner" id="formConatinerVideo">
  ...
  <input type="text" class="form-control" id="topic" name="topic" placeholder="Enter topic with chapter name " required>
       ...
       <a role="button" style="padding:8px 12px;border:1px solid #ddd;outline:none;text-decoration:none;" onclick="document.getElementById('materail').click()">Select Folder</a>
  <input type="file"  style="display:none;" name="smt[]" class="form-control" id="materail" multiple directory='' webkitdirectory='' moxdirectory='' required>
...
$("document").ready(function(){
 $("#cancelUpdation").click(function(){
    ...
    function sendData(){
        ...
        $.ajax({
            url:"src/dashboard/stm/mul_bck.php",
            type:"post",
            data:Data,
            contentType:false,
             processData:false,
